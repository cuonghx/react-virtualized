!function(global, factory) {
    ...
    function _createSuper(Derived) {
        ...
        return function() {
            ...
            return self = this, !(call = result) || "object" != typeof call && "function" != typeof call ? _assertThisInitialized(self) : call;
        };
    }
    ...
    var AutoSizer = function(_React$Component) {
        ...
        function AutoSizer() {
            ...
            _defineProperty(_assertThisInitialized(_this), "_onResize", function() {
                var _this$props = _this.props, disableHeight = _this$props.disableHeight, disableWidth = _this$props.disableWidth, onResize = _this$props.onResize, _this$props$selfWindo = _this$props.selfWindow, selfWindow = void 0 === _this$props$selfWindo ? window : _this$props$selfWindo;
                if (_this._parentNode) {
                    var height = _this._parentNode.offsetHeight || 0, width = _this._parentNode.offsetWidth || 0, style = (_this._window || selfWindow).getComputedStyle(_this._parentNode) || {}, paddingLeft = parseInt(style.paddingLeft, 10) || 0, paddingRight = parseInt(style.paddingRight, 10) || 0, paddingTop = parseInt(style.paddingTop, 10) || 0, paddingBottom = parseInt(style.paddingBottom, 10) || 0, newHeight = height - paddingTop - paddingBottom, newWidth = width - paddingLeft - paddingRight;
